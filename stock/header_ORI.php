...
<div id="header"> 
    ...
    <div id="menu" class="menu">
      <ul id="navg">
		...
		<li><a href="abm_primera_pag.php">ADMINISTRACION</a>
          <ul>
            <?php
            if(Opciones_habilitadas($_SESSION["rol_id"],'CHEQUES')=='S') {
            ?>
                <li><a href="abm_cheques.php?limpiar=S">CHEQUES</a></li>
            <?php
            }
            ?>
          </ul>
        </li>
		<li><a href="abm_primera_pag.php">RRHH</a>
          <ul>
            <?php
            if(Opciones_habilitadas($_SESSION["rol_id"],'EMPLEADOS')=='S') {
            ?>
                <li><a href="abm_empleados.php">EMPLEADOS</a></li>
            <?php
            }
            ?>
          </ul>
