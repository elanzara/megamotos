 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
     //echo'pagi_sql:'.$_pagi_sql;
 	$_pagi_sqlConta = 'select count(*) from ('.$_pagi_sql.') as a';
        //@eregi_replace("select[[:space:]](.*)[[:space:]]from", "SELECT COUNT(*) FROM", $_pagi_sql);
     //$_pagi_sqlConta = str_replace("select[[:space:]](.*)[[:space:]]from", "SELECT COUNT(*) FROM", $_pagi_sql);
        //echo'</br>pagi_sqlConta:'.$_pagi_sqlConta;
