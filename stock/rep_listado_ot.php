...
function llamado_reporte(){
  ...
  window.open('imprimir_listado_ot.php?suc_id='+<?php echo $_SESSION["search_sucursal"]; ?>
...
//        $pdf->SetFontSize(14);
//        $pdf->SetXY(105, 38);
//        $pdf->Write(0, "NEUMATICOS VENDIDOS");
...
//        $detalle = $rep->get_rep_neumaticos_vendidos($_SESSION["search_sucursal"]
...
<div id="page"> 
 ...
 <!-- End HEADER -->
  <!--Start CENTRAL -->
 <div id="central">
  <h1>Reporte de Listado de OT </h1>
  <!--Start Tabla  -->
   <table class="form">
    <tr>
    <td>
    <form action='rep_listado_ot.php' method='POST' enctype='multipart/form-data'>
    <table align="center"  border="0">
      ...
      <tr>
            ...
            <td><input type="text" id="desde" name="desde" value="<?php echo $_SESSION["search_desde"];?>" /></td>
            <td style="padding-left:100px;">Hasta (DD/MM/YYYY):</td>
