...
//echo'tpr:'.$_SESSION["search_tprod"].'-ma:'.$_SESSION["search_marca"].'-su:'.$_SESSION["search_sucursal"];
?>
...
function llamado_reporte(){
  ...
  window.open('imprimir_prod_vendidos.php?tip_id='+<?php echo $_SESSION["search_tprod"]; ?>
 ...
 <div id="central">
  ...
  <!--Start Tabla  -->
   <table class="form">
    <tr>
    <td>
    <form action='rep_productos_vendidos.php' method='POST' enctype='multipart/form-data'>
