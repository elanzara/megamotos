<?php
	$owner_email='info@megallantas.com.ar';
    ...
    $subject='Tienes un mensaje de MegallantasMotos ';
    $user_email='';    
	$message_body='';
	$message_type='html';
	...
	if(isset($_POST['name']) and $_POST['name'] != ''){$message_body .= '<p>Destinatario: ' . $_POST['name'] . '</p>' . "\n" . '<br>' . "\n"; $subject.=$_POST['name'];}
	...
	if(isset($_POST['phone']) and $_POST['phone'] != ''){$message_body .= '<p>Telefono: ' . $_POST['phone'] . '</p>' . "\n" . '<br>' . "\n";}	
